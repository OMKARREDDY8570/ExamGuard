...
def get_user_consent():
    ...
    root =tk.Tk()
    root.withdraw() #hides main window from user
    
    instructions ="these are the permissions:"


    response =messagebox.askyesno(title="EXAM-GUARD consent required",message =instructions)
    root.destroy()
    return response
